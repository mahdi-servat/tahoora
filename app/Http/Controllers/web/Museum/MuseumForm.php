...
class MuseumForm extends Form
{
    ...
    public function buildForm()
    {
        $this
            ...
            ->add("price", "number", ["label_attr" => ["class" => "form-label"], "wrapper" => ["class" => "col-12 col-md-3 mb-1"], "value" => function ($data) {
                return $data;
            }, "attr" => ["class" => "form-control"]])
            ...
            ->add("icon", "file", ["label_attr" => ["class" => "form-label"], "wrapper" => ["class" => "col-12 col-md-3 mb-1"], "value" => function ($data) {
                return $data;
            }, "attr" => ["class" => "form-control col-12 col-md-3 mb-1 "]])
            ->add("category_id", "entity", [
                ...
                "query_builder" => function () {
                    return Category::where('category_type_id', 3)->get();
                }
            ])
