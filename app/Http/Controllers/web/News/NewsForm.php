...
class NewsForm extends Form
{
    ...
    public function buildForm()
    {
        $this
            ...
            ->add("thump", "file", ["label_attr" => ["class" => "form-label"], "wrapper" => ["class" => "col-12 mb-1"], "value" => function ($data) {
                return $data;
            ...
            ->add("top_title", "text", ["label_attr" => ["class" => "form-label"], "wrapper" => ["class" => "col-12 col-md-3 mb-1"], "value" => function ($data) {
                return $data;
            }, "attr" => ["class" => "form-control"]])
            ->add("date", "text", ["label_attr" => ["class" => "form-label"], "wrapper" => ["class" => "col-12 col-md-3 mb-1"], "value" => function ($data) {
