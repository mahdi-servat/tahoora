...
use App\Models\IconMainPage\IconMainPageType;
...
class MediaForm extends Form
{
    ...
    public function buildForm()
    {
        $this
            ...
            ->add('send', 'submit', ['wrapper' => ['class' => 'col-12'], 'attr' => ['name'=>'send','class' => 'btn btn-info btn-tall waves-effect waves-light mt-1']]);
    }
}
