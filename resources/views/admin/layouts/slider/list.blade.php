        ...
        <div class="card-content">
            <div class="card-body">
                <div class="row">
                                ...
                                @if(!empty($data) &&count($data) > 0)
                                    ...
                                    @foreach($data as  $key=>$item)
                                        <tr>
                                            ...
                                            <td>
                                                {{@$item->countOfSlider() == 0 ?'هنوز اسلایدی ثبت نشده است' : $item->countOfSlider()}}
                                            </td>
                                            <td>
                                                @if(@$item->status_id == 1)
                                                    <span
                                            ...
                                            <td>
                                                {{\App\Util::toJalali(@$item->updated_at)}}
                                            </td>
                                            <td>
                                                <div class="dropdown">
                                                    <button type="button"
                    ...
                    @if(!empty($data) &&count($data) > 0 && $data->hasPages())
