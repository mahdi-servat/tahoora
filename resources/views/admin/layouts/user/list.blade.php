                        ...
                        <div class="table-responsive text-nowrap ">
                            <table class="table text-center">
                                ...
                                <tr>
                                    ...
                                    <th>{{__('panel.avatar')}}</th>
                                    <th>{{__('panel.name')}}</th>
                                    <th>{{__('panel.phone')}}</th>
                                            ...
                                            <td>
                                                <div class="avatar-wrapper">
                                                    <div class="avatar mx-auto">
                                                        <img src="/{{@$item->avatar}}" alt="thump" class="rounded-circle">
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="{{route('user.edit' , ['id' => $item->id])}}"
                                                        ><i class="ti ti-pencil me-1"></i> {{__('panel.edit')}}</a
                                                        >
                                                        <a class="dropdown-item" href="{{route('user.destroy' , ['id' => $item->id])}}"
