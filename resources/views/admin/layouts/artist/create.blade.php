    ...
    <div class="card mb-2" style="width: fit-content">
        <div class="card-content">
            <ul class="nav nav-pills" id="pills-tab" role="tablist" >
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-media-tab" data-bs-toggle="pill" data-bs-target="#pills-media" type="button" role="tab" aria-controls="pills-media" aria-selected="false">
                        تصاویر
                    </button>
                </li>
            </ul>
            ...
            <div class="card-content">
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                        <div class="col-12">
                            <?php
                                $social_media = \App\Models\SocialMedia\SocialMedia::get();
                            ?>
                                        ...
                                        @foreach($social_media as $item)
                                            <tr>
                                                ...
                                                <td>
                                                        <?php
                                                            $value = null;
                                                            if (!empty(@$data) && !empty(@$item->artistId($data->id))){
                                                                $value = $item->artistId($data->id)->pivot->value ;
                                                            }
                                                        ?>
                                                    <input type="text" name="social_media[{{$item->id}}]" class="form-control" value="{{$value}}">
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                    ...
                    background-color:#c30606;height: 30px;color: #FFFFFF;border-bottom-right-radius: 10px;border-bottom-left-radius: 10px" onclick="$(this).parent().remove()">
                                            ...
                                            @else
                                                <video controls style="width:100%;border-top-right-radius: 10px;border-top-left-radius: 10px">
...
@section('script')
    <script>
        ...
        function addAv(el) {
            ...
            let url = "{{route('artist.getAttachmentRow')}}?count=" + count
        ...
        $('#language_id').on('change', function () {
            ...
            let url = "{{route('category.index')}}" + '?content_type=json&search=language_id:' + id+ '&search=category_type_id:4'
            $.get(url, function (data) {
